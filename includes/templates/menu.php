 ...
 */
?>
<nav id="nav-menu-container" class="col-xs-2 col-sm-10 hidden-xs visible-md visible-lg hidden-sm" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
